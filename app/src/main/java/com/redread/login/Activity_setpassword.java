...
public class Activity_setpassword extends BaseActivity implements View.OnClickListener {
    ...
    private String deptId="1";//机构id。普通用户为1
    ...
    private void doSetPwd() {
        ...
        mCall.enqueue(new Callback() {
            ...
            public void onResponse(okhttp3.Call call, Response response) throws IOException {
                ...
                //记录用户信息
                SharePreferenceUtil.saveSimpleData(Activity_setpassword.this,Activity_generalLogin.USER_NAME,unameEdi.toString());
                finish2();
            }
        });
    }
