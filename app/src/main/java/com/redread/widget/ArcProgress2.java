 ...
 */
public class ArcProgress2 extends ProgressBar {
    ...
    public ArcProgress2(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }
    public ArcProgress2(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    protected synchronized void onDraw(Canvas canvas) {
        ...
        if (mOnCenter != null) {
            if(mCenterCanvas == null||mCenterBitmap==null){
